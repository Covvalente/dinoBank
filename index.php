...
<header class="site-header sticky-top py-1">
  <nav class="container d-flex flex-column flex-md-row justify-content-between">
    <a class="py-2" href="#" aria-label="DinoBank Logo">
      <img src="dino.png" style="position: absolute; margin-left: 0%; margin-top: -0.7%;" width="50px" height="50px" alt="" srcset="">
</a>
    ...
    <!-- <a class="py-2 d-none d-md-inline-block" href="<?php echo SITE_URL ?>"></a>
    <a class="py-2 d-none d-md-inline-block" href="<?php echo SITE_URL ?>"></a>
    <a class="py-2 d-none d-md-inline-block" href="<?php echo SITE_URL ?>"></a> -->
  </nav>
</header>
...
<main>
  <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
    <div class="col-md-5 p-lg-5 mx-auto my-5">
      <h1 class="display-4 fw-normal">DinoBank</h1>
